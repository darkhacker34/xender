...
class _AppState extends State<App> {
  ...
  List system=[
  {'name': 'Galley', 'logo': 'assets/system_app/gallery.png', 'size': '54.17MB'},
  {'name': 'Google Drive', 'logo': 'assets/system_app/gdrive.png', 'size': '82.17MB'},
  {'name': 'Map', 'logo': 'assets/system_app/gmap.png', 'size': '23.1MB'},
  {'name': 'Google', 'logo': 'assets/system_app/google.png', 'size': '6.7MB'},
  {'name': 'Google Meet', 'logo': 'assets/system_app/google_meet.png', 'size': '75MB'},
  {'name': 'Google Photos', 'logo': 'assets/system_app/google_photos.png', 'size': '2.6MB'},
  {'name': 'Google Play Books', 'logo': 'assets/system_app/google_play_books.png', 'size': '45MB'},
  {'name': 'Google Play Games', 'logo': 'assets/system_app/google_play_games.png', 'size': '8.9MB'},
  {'name': 'Google Play Games', 'logo': 'assets/system_app/google_play_service.png', 'size': '9.3MB'},
  {'name': 'Google TV', 'logo': 'assets/system_app/google_tv.png', 'size': '2.5MB'},
  {'name': 'Messages', 'logo': 'assets/system_app/messages.png', 'size': '1.8MB'},
  {'name': 'Phone', 'logo': 'assets/system_app/phone.png', 'size': '3MB'},
  {'name': 'Settings', 'logo': 'assets/system_app/settings.png', 'size': '765.8KB'},
  {'name': 'Youtube', 'logo': 'assets/system_app/youtube.png', 'size': '113MB'},
            ...
            Container(
              ...
              child: Row(
                ...
                children: [
                  Text('Local'),
                  IconButton(
                    icon: appCheck.length==apps.length?Icon(Icons.check_circle_outline, color: Colors.amber,)
                  ...
                  GridView.builder(
                    ...
                    itemBuilder: (context, index) {
                      return InkWell(
                        ...
                        color: appCheck.contains(index) ? Colors.black12:Colors.white,),
                        child: Stack(
                              children: [
                                Padding(
                                  padding: EdgeInsets.all(wt * 0.02),
                                ...
                                if(appCheck.contains(index))
                                  Positioned(
                                      left: wt * 0.18,
                                      top: wt*0.006,
                                      child: Icon(Icons.check_circle,color: Colors.green,size: wt*0.04,))
                            ...
                            Text('System'),
                              !systemApps?IconButton(
                                ...
                                onPressed: () {
                                  ...
                                  icon: Icon(sysCheck.length == system.length?Icons.check_circle:Icons.radio_button_unchecked),
                              )
                          ],
                        ),
                      )
                  ),
                  if(systemApps)GridView.builder(
                    physics: NeverScrollableScrollPhysics(),
                    shrinkWrap: true,
                    ...
                    itemBuilder: (context, index) {
                      return InkWell(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            borderRadius: BorderRadius.circular(wt*0.01),
                            color: sysCheck.contains(index) ? Colors.black12:Colors.white,
                                ...
                                children: [
                                  Container(
                                    ...
                                    decoration: BoxDecoration(
                                        ...
                                        BorderRadius.circular(wt * 0.01),
                                        image: DecorationImage(
                                            image: AssetImage(system[index]['logo']),
                                            fit: BoxFit.cover)),
                                  ),
                                  Text(
                                    system[index]['name'],
